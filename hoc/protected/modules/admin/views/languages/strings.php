    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="containerHeadline">
                <i class="icon-edit"></i><h2><?php echo Yii::t('adminlang', 'Language Strings'); ?></h2>
			...
			<table class="items table">
				...
				<tbody>
							    ...
							    <td>&nbsp;
							    	<?php if( $string->translation != $orig->message ): ?>
										<a href="<?php echo $this->createUrl('languages/revert', array( 'id' => $string->language, 'string' => $string->id )); ?>" title="<?php echo Yii::t('adminlang', 'Revert translation to original'); ?>" class='tooltip'>
											<img src="<?php echo Yii::app()->themeManager->baseUrl; ?>/img/icons/revert.png" alt="revert" />
										</a>
									<?php endif; ?>
                                    
                                    <a class="delete-row" href="<?php echo $this->createUrl('languages/delete', array( 'id' => $string->id )); ?>" title="<?php echo Yii::t('adminlang', 'Delete'); ?>" class='tooltip'>
										<img src="<?php echo Yii::app()->themeManager->baseUrl; ?>/img/icons/cross.png" alt="revert" />
									 </a>
							    </td>
							</tr>	
						<?php endforeach; ?>
					...
					<tr>
						<td colspan='4' style='text-align:right;' class="footer tar"><?php echo CHtml::submitButton(Yii::t('adminlang', 'Submit'), array('name'=>'submit','class' => 'btn btn-primary')); ?></td>
					</tr>
			...
			<?php echo CHtml::endForm(); ?> </div> </div>
        </div>
