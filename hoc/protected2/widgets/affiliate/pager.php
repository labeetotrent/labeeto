...
{	
	...
	const CSS_SELECTED_PAGE='page paginate_active';
	
	/**
	 * default html options
	 */
	public $htmlOptions = array( 'class' => 'dataTables_paginate paging_full_numbers' );
	/**
	 * Header and footer
	 */
	public $header = '';
	...
	public function run()
	{
		...
		if(empty($buttons))
			return;
		echo $this->header;
		echo '<div class="table-sorting"><div class="pager">'.CHtml::tag('div',$this->htmlOptions,implode("\n",$buttons)).'</div></div>';
		echo $this->footer;
	}
