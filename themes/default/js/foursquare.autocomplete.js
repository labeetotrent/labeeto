(function( $ ) {
    ...
    $.fn.fs_suggest = function(options) {
        ...
        var defaults = {
            ...
            v : '20140806', //the date of the foursquare api version
            limit : 10, //perhaps an option to ignore limits
            client_id : "RFXZ4ISD3DYHKTS1RMEXJXONGCJJWUOR3CYKA4RQ5DAD2IUO", //get this from foursquare.com
            client_secret : "RAWC0CJUFMVHWYW0GXJ3KRQPNYXFODRZVBBB1FFUN4CNYMIY", //same
    ...
    function addResultsList(el) {
        el.after("<ul id='fs_search_results' class='col-md-12'></ul>");
    ...
    function buildResultsList() {
        ...
        if(minivenues && minivenues.length > 0) {
            ...
            for (var i = 0; i < minivenues.length; i++) {
                ...
                results += '<li><a class="geo-place col-md-12" href="#" lat="' + v.location.lat + '" lon="' + v.location.lng + '"><span class="geo-name col-md-6">' + v.name + '</span><span class="geo-address col-md-4">' + v.location.address + '</span><span class="geo-distance col-md-2">' + v.location.distance + 'm.</span></a></li>';
            }
        } else {
