<div class="content-box"><!-- Start Content Box -->
	...
	<div class="content-box-content">
		...
		<?php echo $this->createAbsoluteUrl('/extensions/category/', array('lang'=>false)) . '/' . CHtml::activeTextField($model, 'alias', array( 'class' => 'text-input medium-input' )); ?>
		...
		<small><?php echo Yii::t('extensions', 'Choose a category that this category will be a child of.'); ?></small><br />
		<?php echo CHtml::activeDropDownList($model, 'parentid', $parents, array( 'prompt' => Yii::t('extensions', '-- Root --'), 'class' => 'text-input medium-input' )); ?>
		...
		<small><?php echo Yii::t('extensions', 'The language the category can be displayed in.'); ?></small><br />
		...
		<small><?php echo Yii::t('extensions', 'User roles that can view this category (Defaults to nobody)'); ?></small><br />
		...
		<?php echo CHtml::activeLabel($model, 'addpostsperms'); ?>
		<small><?php echo Yii::t('extensions', 'User roles that can add blog to this category (Defaults to nobody)'); ?></small><br />
		<?php echo CHtml::activeListBox($model, 'addpostsperms', $roles, array( 'size' => 20, 'multiple' => 'multiple', 'class' => 'text-input medium-input' )); ?>
		<?php echo CHtml::error($model, 'addaddpostspermsperms', array( 'class' => 'input-notification errorshow png_bg' )); ?>
		
		<?php echo CHtml::activeLabel($model, 'addcommentsperms'); ?>
		<small><?php echo Yii::t('extensions', 'User roles that can add comments to this category (Defaults to nobody)'); ?></small><br />
		...
		<small><?php echo Yii::t('extensions', 'User roles that can add files to this category (Defaults to nobody)'); ?></small><br />
		...
		<small><?php echo Yii::t('extensions', 'User roles that can add blog this category without the need of manual approval (Defaults to nobody)'); ?></small><br />
