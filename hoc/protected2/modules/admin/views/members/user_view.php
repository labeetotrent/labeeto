                                ...
                                <div class="ucard clearfix">                                    
                                    <div class="right">
                                        ...
                                        <ul class="control">                
                                            ...
                                            <li><span class="icon-user"></span> <a href="ui.html"><?php echo Yii::t('global','Status') ?></a></li>
                                            <li><span class="icon-info-sign"></span> <a href="users.html"><?php echo Yii::t('global','Information') ?></a></li>
                                            <li><span class="icon-envelope"></span> <a href="messages.html"><?php echo Yii::t('global','Send message') ?></a></li>
                                        </ul>                                                                                     
                                    </div>
                                </div>                                 
                            </div>                                                                                
                                ...
                                <div class="block-fluid ucard">
                                        ...
                                        <div class="info">                                                                
                                            <ul class="rows">
                                                ...
                                                <li>
                                                    <div class="title"><?php echo Yii::t('global','Name:')?></div>
                                                    <div class="text"><?php echo Yii::t('global','Dmitry')?></div>
                                                </li>
                                                <li>
                                                    <div class="title"><?php echo Yii::t('global','Surname:')?></div>
                                                    <div class="text"><?php echo Yii::t('global','Ivaniuk')?></div>
                                                </li>
                                                <li>
                                                    <div class="title"><?php echo Yii::t('global','Email:')?></div>
                                                    <div class="text"><?php echo $model->email; ?></div>
                                                </li>
                                                <li>
                                                    <div class="title"><?php echo Yii::t('global','Gender:')?></div>
                                                    <div class="text"><?php echo Yii::t('global','Male')?></div>
                                                </li>
                                                <li>
                                                    <div class="title"><?php echo Yii::t('global','Age:')?></div>
                                                    <div class="text">23</div>
                                                </li>
                                                <li>
                                                    <div class="title"><?php echo Yii::t('global','Signature:')?></div>
                                                    <div class="text"><?php echo Yii::t('global','Phasellus ut diam quis dolor mollis tristique. Suspendisse vestibulum convallis felis vitae facilisis.')?></div>
                                                </li>                                     
                                            </ul>                                                      
                                        </div>                        
                                </div>
