<div class="content-box"><!-- Start Content Box -->
	...
	<div class="content-box-content">
		...
		<?php echo $this->createAbsoluteUrl('/blog/category/', array('lang'=>false)) . '/' . CHtml::activeTextField($model, 'alias', array( 'class' => 'text-input medium-input' )); ?>
		...
		<small><?php echo Yii::t('adminblog', 'Choose a category that this category will be a child of.'); ?></small><br />
		<?php echo CHtml::activeDropDownList($model, 'parentid', $parents, array( 'prompt' => Yii::t('adminblog', '-- Root --'), 'class' => 'text-input medium-input' )); ?>
		...
		<small><?php echo Yii::t('adminblog', 'The language the category can be displayed in.'); ?></small><br />
		...
		<small><?php echo Yii::t('adminblog', 'User roles that can view this category (Defaults to nobody)'); ?></small><br />
		...
		<small><?php echo Yii::t('adminblog', 'User roles that can add blog to this category (Defaults to nobody)'); ?></small><br />
		...
		<small><?php echo Yii::t('adminblog', 'User roles that can add comments to this category (Defaults to nobody)'); ?></small><br />
		...
		<small><?php echo Yii::t('adminblog', 'User roles that can add files to this category (Defaults to nobody)'); ?></small><br />
		...
		<small><?php echo Yii::t('adminblog', 'User roles that can add blog this category without the need of manual approval (Defaults to nobody)'); ?></small><br />
