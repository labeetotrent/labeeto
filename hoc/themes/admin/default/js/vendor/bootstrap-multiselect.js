	...
	Multiselect.prototype = {
		...
		createOptionValue: function(element) {
			...
			if (inputType == 'checkbox') {
				var $li = $('<li><a href="javascript:void(0);" style="padding: 9px 0 1px 5px;"><input id="' + inputType + value + '" class="css-checkbox" type="' + inputType + '" /><label for="' + inputType + value + '" class="css-label"></label></a></li>');
			}

			if (inputType == 'radio') {
				var $li = $('<li><a href="javascript:void(0);" style="padding: 9px 0 1px 5px;"><input id="' + inputType + value + '" class="css-radio" type="' + inputType + '" /><label for="' + inputType + value + '" class="css-label radio"></label></a></li>');
			}
