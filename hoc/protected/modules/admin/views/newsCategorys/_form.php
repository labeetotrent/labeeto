...
<div class="span12">
    <div class="containerHeadline">
        <i class="icon-ok-sign"></i><h2><?php echo Yii::t('global','News Categorys'); ?></h2>
...
/*                        $condition = array('parent_id' => 0);
                        ...
                        $list = CHtml::listData(NewsCategorys::model()->findAllByAttributes($condition, $criteria ), 'id', 'name' );
