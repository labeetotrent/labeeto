...
class CountriesController extends AdminBaseController {
    public function init()
	{
		...
		$this->breadcrumbs[ Yii::t('global', 'Countries') ] = array('countries/index');
		$this->pageTitle[] = Yii::t('global', 'Countries');
	}
	...
	{
		$model=Countries::model()->findByPk((int)$id);
		if($model===null)
