...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row-form clearfix">
		...
		<div class="span9">
            <?php $this->widget('application.widgets.ckeditor.CKEditor', array( 'name' => 'Blog[description]', 'value' => isset($model->description) ? $model->description : '', 'editorTemplate' => 'full' )); ?>
	...
	<div class="row-form clearfix">
		...
		<div class="span9">
            <?php $this->widget('application.widgets.ckeditor.CKEditor', array( 'name' => 'Blog[content]', 'value' => isset($model->content) ? $model->content : '', 'editorTemplate' => 'full' )); ?>
