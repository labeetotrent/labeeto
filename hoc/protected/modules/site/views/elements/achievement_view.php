        ...
        <div class="profile">
            ...
            <div class="crycle-img">
                <h2>
                    ...
                    <div id="ach-<?=$data->id;?>" class="hidden"><img src="https://maps.googleapis.com/maps/api/staticmap?center=<?=$data->location->lat.','.$data->location->lon;?>&zoom=12s&size=100x100&markers=color:red|<?=$data->location->lat.','.$data->location->lon;?>" width="100" style="width: 100px; height: 100px;"/></div>
