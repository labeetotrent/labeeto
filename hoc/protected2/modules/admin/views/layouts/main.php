...
<html lang="en">
    ...
    <?php Yii::app()->clientScript->registerScriptFile( Yii::app()->themeManager->baseUrl . '/js/plugins//multiselect/jquery.multi-select.js' ); ?>
...
<body>
	<div class="wrapper ">
        ...
        <div class="header">
			<a class="logo" href="<?php echo $this->createUrl('index/index', array('lang'=>false)); ?>"><img style="height:37px;" src="<?php echo Yii::app()->themeManager->baseUrl; ?>/../../default/img/logo.png" alt="Admin Panel" title="Admin Panel"/></a>
		...
		<div class="menu">
			<div class="breadLine">            
                ...
                <div class="adminControl active">
                    <?php echo Yii::t('global','Hi')?>, <?php echo Yii::app()->user->name; ?>
                </div>
            </div>

            <div class="admin">
                <ul class="control">                
                    <li><span class="icon-refresh"></span> <a href="#" onclick="window.location.href=window.location.href"><?php echo Yii::t('global','Refresh')?></a></li>
                    <li><span class="icon-globe"></span> <a target="_blank" href="<?php echo Yii::app()->homeUrl; ?>"><?php echo Yii::t('global','View site')?></a></li>
                    <li><span class="icon-share-alt"></span> <a href="<?php echo $this->createUrl('/logout', array('lang'=>false)); ?>"><?php echo Yii::t('global','Logout')?></a></li>
                </ul>
            </div>
