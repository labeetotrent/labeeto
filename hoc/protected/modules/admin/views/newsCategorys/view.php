...
<div class="container-fluid">
    <div class="page-header" style="border-bottom: 0px solid !important">
        <h1>View <small>
       <small><?php echo Yii::t('global', 'NewsCategorys'); ?> #<?php echo $model->id; ?></small></h1>
    </div>
    <div class="row-fluid">
    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="containerHeadline tableHeadline">
                ...
                <h2><?php echo Yii::t('global', 'Category'); ?> </h2>
            ...
            <div class="floatingBox table table-view-user">
                <div class="container-fluid">
                    ...
                    array('name'=>'id'),
                    array('name'=>'name'),
                    //array('name'=>'parent_id','value'=> NewsCategorys::model()->getParentCategory( $model->parent_id ) ),
                    array('name'=>'alias'),
                    array('name'=>'created'),
                    array('name'=>'updated'),
                    ),
