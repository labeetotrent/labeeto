<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('passion')); ?>:</b>
	<?php echo CHtml::encode($data->passion); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('last_logged')); ?>:</b>
	<?php echo CHtml::encode($data->last_logged); ?>
	<br />
