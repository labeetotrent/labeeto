...
class FacebookRedirectLoginHelper
{
     ...
     * @var string
     */
  private static $defaultRedirectUrl = 'http://labeeto3.cloudapp.net/index/facebookSignup';
  /**
   ...
   */
    public function __construct($redirectUrl = null, $appId = null, $appSecret = null)
    {
        if(!$redirectUrl)
