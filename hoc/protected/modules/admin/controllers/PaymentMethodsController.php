...
class PaymentMethodsController extends AdminBaseController {
    public function init()
	{
		...
		$this->breadcrumbs[ Yii::t('global', 'Payment Methods') ] = array('paymentMethods/index');
		$this->pageTitle[] = Yii::t('global', 'Payment Methods');
	}
	...
	{
		$model=PaymentMethods::model()->findByPk((int)$id);
		if($model===null)
